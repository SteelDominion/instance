...
function normal_states.entry(this, context)
    context:runAnimation("roll_roll_roll_your_boat", context:getTrack(STATIC_TRACK_LINE, BOLT_CAUGHT_TRACK), false, PLAY_ONCE_STOP, 0)
...
function normal_states.update(this, context)
    ...
    context:setAnimationProgress(context:getTrack(STATIC_TRACK_LINE, BOLT_CAUGHT_TRACK), 21.5 - context:getAmmoCount(), false)
end
