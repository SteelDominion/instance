...
function M.tick_reload(api)
    ...
    if (reloaded_count >= 0) then
        ...
        while (base_time < reload_time) do
            ...
            if (cache.needed_count == 10) then
                reloaded_count = reloaded_count + 11
                api:putAmmoInMagazine(api:isReloadingNeedConsumeAmmo() and api:consumeAmmoFromPlayer(10) or 10)
            else
